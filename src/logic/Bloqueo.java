...
/**
 * Clase encargada del bloqueo
 * el cual sera un hilo que estara
 * pendiente de los procesos que entre
 * a bloqueo y los desbloqueados
 * @author - SO2017
 */
public class Bloqueo implements Runnable {
    ...
    /**
     * Agregar proceso en la lista de bloqueo y 
     * despausar en caso de lo que estuviera
     * @param proceso que entrara ser bloqueado
     */
    ...
    /**
     * Recorre la lista actual y retorna aquellos
     * procesos que se encuentra en estado
     * bloqueado
