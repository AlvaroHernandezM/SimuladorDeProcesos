 ...
 * y los m�todos que se pueden ejecutar 
 */
public class ColaProcesos {
	 ...
	 * @param proceso que se desea agregar
	 */
	 ...
	 * y eliminando dicha posici�n (COLA)
	...
	/**
	 * @return el proceso pero sin eliminarlo de la cola
	 */
	public Proceso getProcesoAux(){
		return this.deque.get(0);
	}
	/**
	 * Obtener un proceso en especifico de la lista
	 * sin eliminarlo
	 * @param pos Posicion en la que se encuentra 
	 * el proceso
	 ...
	 * @param pos posicion la cual se desea elimianr
	 */
	...
	/**
	 * Asginar nueva lista
	 * @param deque lista para asignar
	 */
