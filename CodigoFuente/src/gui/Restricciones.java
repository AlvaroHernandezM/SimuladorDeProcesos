...
public class Restricciones {
    ...
    public boolean asignarMemoria (JFrame frame,JTextField campoMemoria){
        if (campoMemoria.getText().isEmpty()){
            JOptionPane.showMessageDialog(frame, "Debe_asignar_Espacio_a_memoria");
            return false;
        }
        return true;
    }
